...
//import simpleTimer.TimerThread;
public class Test extends JFrame  implements Runnable 
{
	...
	// protected static final int[] Error1 = null;
   //=========================================================
	 
	 public int time = 1;	boolean isRun = true;
		public void run() {	
			while(isRun){			
				try {
					//倒计时	
     ...
     /* button1 = new JButton("继续");
      button1.setBounds(150, 400, 100,25);
      add(button1);
      */
      ...
      button1.addActionListener(new ActionListener()
		{
			...
			// TimerThread timer = new TimerThread();
				...
				thread1.stop();
					...
					for(int i=0;i<20;i++)
					 {
						 ...
						 {
							 //System.out.print(intAnswer.get(i)+"  ");
		        	...
		        	//Competitor ug = new Competitor(c1,c2,summary);
		          //  competition.add(ug);
	...
	/*	button2.addActionListener(new ActionListener()
		{
				public  void actionPerformed(ActionEvent  event)
				{
					 ...
					 sort[9]=Integer.parseInt(c11);
		        	  sort[8]=Integer.parseInt(c12);
		        	  sort[7]=Integer.parseInt(c13);
		        	  sort[6]=Integer.parseInt(c14);
		        	  sort[5]=Integer.parseInt(c15);
		        	  sort[4]=Integer.parseInt(c16);
		        	  sort[3]=Integer.parseInt(c17);
		        	  sort[2]=Integer.parseInt(c18);
		        	  sort[1]=Integer.parseInt(c19);
		        	  sort[0]=Integer.parseInt(c10);
		        	  
		        	  java.util.Arrays.sort(sort);
		        	  
		        	double summary = (sort[1]+sort[2]+sort[3]+sort[4]+sort[5]+sort[6]+sort[7]+sort[8])/8;
		            ...
		            if(event.getSource()==button2)
					{
		            	setVisible(false);
		            	   competition.sort(null);
		            		Summary m =  new  Summary(competition);
		            		m.setVisible(true);
		            		m.setSize(DEFAULT_WIDTH, DEFAULT_HEIGHT);
